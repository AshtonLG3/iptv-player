...
D-pad. It opens SportyTV's live player first. Pressing Down moves straight to
the currently live programme cards without stepping through the date strip or
site navigation, and Up from the first card returns to the player. TV-only apps
such as SABC+ are resolved through Android's Leanback
...
live cards remain directly reachable with the remote. It starts compatible HTML video
